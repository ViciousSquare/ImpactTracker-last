...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Leaderboard
    'impactboard.title': 'Impactboard',
    'impactboard.subtitle': 'Top organizations by Impact IQ score',
    'impactboard.allSectors': 'All sectors',
    'impactboard.allRegions': 'All regions',
    'impactboard.allSDGs': 'All SDGs',
    'impactboard.bySector': 'By Sector',
    'impactboard.exploreBySector': 'Explore top organizations in different sectors',
    'impactboard.viewAll': 'View All',
    'impactboard.seeMoreInSector': 'See more in this sector',
  ...
  fr: {
    ...
    // Impactboard
    'impactboard.title': 'Tableau d\'impact',
    'impactboard.subtitle': 'Les meilleures organisations par score d\'impact IQ',
    'impactboard.allSectors': 'Tous les secteurs',
    'impactboard.allRegions': 'Toutes les régions',
    'impactboard.allSDGs': 'Tous les ODD',
    'impactboard.bySector': 'Par Secteur',
    'impactboard.exploreBySector': 'Explorez les meilleures organisations dans différents secteurs',
    'impactboard.viewAll': 'Voir Tout',
    'impactboard.seeMoreInSector': 'Voir plus dans ce secteur',
